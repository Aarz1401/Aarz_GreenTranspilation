...
OUTPUT_CSV = Path("energy_results_combined_v3.csv")
...
def run_cpp_with_energy(exe_path: Path, min_temp=43.0, max_temp=45.0, interval=2):
    ...
    while True:
        ...
        print(f"CPU stabilized at {temp:.1f}°C\n")
        break
...
def main():
    ...
    cpp_files = sorted(ROOT.glob("**/*_benchmark.cpp"))
    py_files = sorted(ROOT.glob("**/*_with_tests.py"))
